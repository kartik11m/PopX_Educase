                    ...
                    <div>
                        ...
                        <div>
                            <div className="relative h-[40px] w-full mb-[39px]">
                                <input id="full-name" type="text" placeholder='Full Name' className="w-full px-4 py-3 border border-[#CBCBCB] rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-gray-500 focus:border-gray-500" required/>
                            ...
                            <div className="relative h-[40px] w-full mb-[39px]">
                                <input id="phone-number" type='number' placeholder='Phone number' className="w-full px-4 py-3 border border-[#CBCBCB] rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-gray-500 focus:border-gray-500" required/>
                                <label for="full-name-input" className="absolute left-3 -top-2.5 px-1 text-[13px] bg-[#F7F8F9]">
                            ...
                            <div className="relative h-[40px] w-full mb-[39px]">
                                <input id="email" type="email" placeholder='Email' className="w-full px-4 py-3 border border-[#CBCBCB] rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-gray-500 focus:border-gray-500" required/>
                                <label for="full-name-input" className="absolute left-3 -top-2.5 px-1 text-[13px] bg-[#F7F8F9]">
                            ...
                            <div className="relative h-[40px] w-full mb-[39px]">
                                <input id="pass" type="password" placeholder='Password' className="w-full px-4 py-3 border border-[#CBCBCB] rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-gray-500 focus:border-gray-500" required/>
                                <label for="full-name-input" className="absolute left-3 -top-2.5 px-1 text-[13px] bg-[#F7F8F9]">
                            ...
                            <div>
                                ...
                                <div className='flex'>
                                    <div className="flex items-center me-4">
                                        <input type="radio" value="Yes" name="agency" className="w-4 h-4 accent-[#6C25FF]" required/>
                                        <label for="radio" className="ms-2 text-[14px] font-normal">Yes</label>
                                    </div>
                                    <div className="flex items-center me-4">
                                        <input type="radio" value="No" name="agency" className="w-4 h-4 accent-[#6C25FF]" required/>
                        ...
                        <button type='submit' className="w-full text-[16px] rounded-lg bg-[#6C25FF] py-2 text-white font-medium hover:bg-violet-800 transition mb-3 cursor-pointer">
                            Create Account
                        </button> 
                </form>
            </div>
